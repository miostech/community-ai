...
export function Button({ 
  ...
  // Se className contém classes que sobrescrevem, aplica por último
  const finalClassName = className.includes('bg-') || className.includes('text-') || className.includes('border-')
