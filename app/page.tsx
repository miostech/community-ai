  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-72 h-72 bg-blue-100 dark:bg-blue-500/20 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-xl opacity-30 dark:opacity-40 animate-blob"></div>
        <div className="absolute top-40 right-10 w-72 h-72 bg-purple-100 dark:bg-purple-500/20 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-xl opacity-30 dark:opacity-40 animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-8 left-1/2 w-72 h-72 bg-pink-100 dark:bg-pink-500/20 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-xl opacity-30 dark:opacity-40 animate-blob animation-delay-4000"></div>
      </div>
      ...
      <section className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-24 sm:pt-32 pb-12 sm:pb-20 md:pt-40 md:pb-32">
        <div className="text-center space-y-6 sm:space-y-8">
          {/* Launch Banner */}
          <div className="inline-flex items-center space-x-2 bg-blue-50 dark:bg-blue-950/50 border border-blue-100 dark:border-blue-800 rounded-full px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm text-blue-700 dark:text-blue-300">
          ...
          <div className="space-y-3 sm:space-y-4">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 dark:text-slate-100 leading-tight px-2">
              Dê vida às suas ideias de conteúdo
            </h1>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed px-4">
          ...
          <form onSubmit={handleSubmit} className="max-w-3xl mx-auto mt-8 sm:mt-12 px-4" suppressHydrationWarning>
            <div className="relative flex items-center bg-white dark:bg-slate-800/80 border-2 border-gray-200 dark:border-slate-600 rounded-xl sm:rounded-2xl p-1.5 sm:p-2 shadow-lg hover:border-gray-300 dark:hover:border-slate-500 transition-all focus-within:border-blue-500 dark:focus-within:border-blue-400 focus-within:shadow-xl">
              <input
                type="text"
                value={inputValue}
                onChange={(e) => setInputValue(e.target.value)}
                placeholder={placeholderText || 'Crie ideias de conteúdo para Instagram'}
                className="flex-1 px-3 sm:px-6 py-3 sm:py-4 text-sm sm:text-base md:text-lg outline-none bg-transparent text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-slate-500"
                suppressHydrationWarning
              />
              <button
                type="submit"
                className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-400 rounded-lg sm:rounded-xl flex items-center justify-center transition-colors shadow-md hover:shadow-lg flex-shrink-0"
              >
              ...
              >
                {[...suggestedPrompts, ...suggestedPrompts].map((prompt, index) => (
                  <button
                    ...
                    className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-50 dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-full text-xs sm:text-sm text-gray-700 dark:text-slate-300 transition-colors whitespace-nowrap flex-shrink-0"
                  >
                    {prompt}
                  </button>
                ))}
          ...
          <div className="mt-8 sm:mt-12 md:mt-16 flex items-center justify-center space-x-2 sm:space-x-3">
            <div className="flex -space-x-1.5 sm:-space-x-2">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 border-2 border-white dark:border-black"></div>
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-purple-400 to-purple-600 border-2 border-white dark:border-black"></div>
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-pink-400 to-pink-600 border-2 border-white dark:border-black"></div>
            </div>
      ...
      <section id="criadores" className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-6 sm:pt-8 pb-8 sm:pb-12">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-slate-100 mb-2 sm:mb-3 px-2">Criado por especialistas em conteúdo</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl border border-gray-100 dark:border-slate-700 p-6 sm:p-8 text-center hover:shadow-lg transition-all">
            <div className="mb-4 sm:mb-6">
              ...
              />
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-slate-100 mb-1 sm:mb-2">Natália Trombelli</h3>
              <p className="text-gray-600 dark:text-slate-400 text-xs sm:text-sm mb-2">@natrombellii</p>
              <div className="flex items-center justify-center space-x-1 mb-4">
                <svg className="w-4 h-4 text-gray-400 dark:text-slate-500" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" />
                </svg>
                <span className="text-sm font-semibold text-gray-700 dark:text-slate-300">+1.1 milhão</span>
          ...
          <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl border border-gray-100 dark:border-slate-700 p-6 sm:p-8 text-center hover:shadow-lg transition-all">
            <div className="mb-4 sm:mb-6">
              ...
              />
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-slate-100 mb-1 sm:mb-2">Luigi Andersen</h3>
              <p className="text-gray-600 dark:text-slate-400 text-xs sm:text-sm mb-2">@luigi.andersen</p>
              <div className="flex items-center justify-center space-x-1 mb-4">
                <svg className="w-4 h-4 text-gray-400 dark:text-slate-500" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" />
                </svg>
                <span className="text-sm font-semibold text-gray-700 dark:text-slate-300">+772 mil</span>
                <span className="text-sm text-gray-500 dark:text-slate-400">seguidores</span>
              </div>
            </div>
            <p className="text-sm sm:text-base text-gray-700 dark:text-slate-300 leading-relaxed mb-4 sm:mb-6">
      ...
      <section id="recursos" className="relative max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-slate-100 mb-2 sm:mb-4 px-2">Recursos</h2>
          <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-slate-400 max-w-2xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl border border-gray-100 dark:border-slate-700 p-4 sm:p-6 hover:shadow-lg transition-all">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 dark:bg-blue-500/20 rounded-xl flex items-center justify-center mb-3 sm:mb-4">
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
              </svg>
            </div>
            <h3 className="font-semibold text-gray-900 dark:text-slate-100 text-base sm:text-lg mb-1 sm:mb-2">Ideias Estruturadas</h3>
          ...
          <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl border border-gray-100 dark:border-slate-700 p-4 sm:p-6 hover:shadow-lg transition-all">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-pink-100 dark:bg-pink-500/20 rounded-xl flex items-center justify-center mb-3 sm:mb-4">
            ...
            <h3 className="font-semibold text-gray-900 dark:text-slate-100 text-base sm:text-lg mb-1 sm:mb-2">Chat com IA</h3>
            <p className="text-gray-600 dark:text-slate-400 text-xs sm:text-sm leading-relaxed">
          ...
          <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl border border-gray-100 dark:border-slate-700 p-4 sm:p-6 hover:shadow-lg transition-all">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-100 dark:bg-green-500/20 rounded-xl flex items-center justify-center mb-3 sm:mb-4">
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
            </div>
            <h3 className="font-semibold text-gray-900 dark:text-slate-100 text-base sm:text-lg mb-1 sm:mb-2">Comunidade</h3>
            <p className="text-gray-600 dark:text-slate-400 text-xs sm:text-sm leading-relaxed">
