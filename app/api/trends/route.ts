// API de Trends desativada temporariamente — não está em uso no momento.
// Para reativar, descomente todo o conteúdo abaixo.

import { NextResponse } from 'next/server';

export async function GET() {
  return NextResponse.json({ error: 'API de trends desativada temporariamente.' }, { status: 503 });
}
