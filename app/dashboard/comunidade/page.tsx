...
export default function ComunidadePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto w-full pb-24 sm:pb-8 bg-white min-h-screen">
      ...
      <div className="mb-0 bg-white border-b border-gray-200 pb-3 pt-3">
      ...
      {showCreateModal && (
        ...
        >
          <div className="w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-3xl bg-white sm:rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col">
            {/* Header */}
